...
<div class="grw-header-content-wrapper">
   <span class="grw-business-name"><a href="'+t+'" rel="nofollow" target="_blank" title="'+r+'">'+r+'</a></span>
   <div class="grw-google-rating-content">
      <div class="grw-google-star-rating-wrapper">
         <div class="grw-google-star-rating" style="width:'+Math.round(67*a/5)+'px"></div>
      </div>
   </div>
   <div class="grw-rating-value">'+a+" out of 5 stars</div>
</div>
",l},i.buildReviews=function(e,r){var t="grw-reviews-wrapper",a="grw-review",l=i.helpers.createElem("div",{class:"grw-reviews-compact grw-slider"}),n=i.helpers.createElem("div",{class:"grw-slider-nav"});r.horizontal&&(t="grw-reviews-wrapper grw-slider-wrapper",a="grw-review grw-review-slide");for(var s=i.helpers.createElem("div",{class:t}),d=e.reviews,c=0;c<d.length;c++){var o=d[c].author_name,v=d[c].rating,g=d[c].text,p='
<div class="'+a+'">
   <div class="grw-author">'+o+'</div>
   <div class="grw-review-rating">
      <div class="grw-google-star-rating-wrapper">
         <div class="grw-google-star-rating" style="width:'+Math.round(67*v/5)+'px"></div>
      </div>
   </div>
...
";s.innerHTML+=p;var u=i.helpers.createElem("a",{href:"#","data-grw-slide":c});0==c&&(u.className="grw-slide-current"),n.appendChild(u)}return r.horizontal?(l.appendChild(s),l.appendChild(n),i.helpers.initSlider(l),r.autoScroll===!0&&setInterval(function(){var e=n.querySelector(".grw-slide-current"),r=e.nextSibling;null==r&&(r=n.firstChild),r.click()},1e3*r.scrollInterval),l):s},i.buildWidgetFooter=function(){var e=i.helpers.createElem("div",{class:"grw-business-footer grw-clear-fix"});return e.innerHTML='
<div class="poweredByGoogle"></div>
',e},window.$GrwJS=i}(this,this.document);
